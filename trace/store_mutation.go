...
func (s *GOBSymbolStore) saveFileLocked(ctx context.Context, filePath, contentHash string, extractorVersion *string, symbols []Symbol, refs []Reference, beforeVersion func()) error {
	if err := ctx.Err(); err != nil {
		return err
	}
